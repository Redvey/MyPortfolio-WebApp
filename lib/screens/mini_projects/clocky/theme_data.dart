...
class CustomColors {
  ...
  static Color pageBackgroundColor = Color(0xFF2E2F41);
  static Color menuBackgroundColor = Color(0xFF242633);

  static Color clockBG = Color(0xFF45465E);
  static Color clockOutline = Color(0xFFEAECFF);
  static Color? secHandColor = Color(0xFF71FFCF);
